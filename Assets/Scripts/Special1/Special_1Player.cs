...
//	const float CON_RIDEBALL_ACCELE_Y = -20.0f;	// 玉に乗るときの加速度Y
	...
	Special_1PlayerMotion cs_Special_2PlayerMotion;
	//Vector3 vStartEular;
	//Vector3 vEndEular;
	...
	void Start ()
	{
		...
		cs_Special_2PlayerMotion = GetComponent<Special_1PlayerMotion>();
	}
	...
	public bool BackJamp()
	{
		...
		if (bInit)
		{
			...
			cs_Special_2PlayerMotion.Backjamp_Start();	// 後方ジャンプモーション
